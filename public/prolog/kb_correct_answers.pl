...
% module MSU
correct_answer(msu, 1, '251').
correct_answer(msu, 2, '7296').
correct_answer(msu, 3, '41375').


% module MSS
correct_answer(mss, 1, '475').
correct_answer(mss, 2, '3948').
correct_answer(mss, 3, '25869').