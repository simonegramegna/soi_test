...
export const Cmr = () => {
    ...
    return (
        ...
        <div className="alert alert-secondary show my-2 col-span-12" role="alert"><strong>Tips</strong>: click on images to enlarge. Enter the number of the corresponding figure (i.e. 1, 2, 3). Each element corresponds to one an only one figure. Each answers must respond to "What comes in between?"</div>
